 ...
 * Slug: abisko/general-testimonials
...
<div class="wp-block-columns alignwide">
	<!-- wp:column {"width":"25%","className":"is-style-abisko-minus-90-deg-column-content-desktop"} -->
	<div class="wp-block-column is-style-abisko-minus-90-deg-column-content-desktop" style="flex-basis:25%">
		<!-- wp:heading -->
				...
				<div class="wp-block-column">
					...
					<div class="wp-block-group">
						...
						<figure class="wp-block-pullquote has-medium-font-size"
							...
							<blockquote>
								<p>The fine-tuned layouts and type in Abisko makes it a perfect match for both blogs and
									personal websites.</p>
							</blockquote>
						</figure>
						<!-- /wp:pullquote -->
