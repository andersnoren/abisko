...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column"
			...
			<!-- wp:image {"align":"center","width":48,"linkDestination":"none"} -->
			<figure class="wp-block-image aligncenter is-resized"><img
					src="http://localhost:8888/utsikt/wp-content/themes/abisko/assets/images/icons/cube.png" alt=""
					width="48" /></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
